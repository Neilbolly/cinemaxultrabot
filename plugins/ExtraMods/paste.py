...
async def pasty(client, message):
    ...
    if ' ' in message.text:
        ...
        await message.reply("Sorry No In Pᴜᴛ. Pʟᴇᴀꜱᴇ Rᴇᴩʟʏ To A Tᴇxᴛ Oʀ /paste Wɪᴛʜ Tᴇxᴛ")
    if not tex_t:
        if not message.reply_to_message:
            await pablo.edit("Only Tᴇxᴛ Anᴅ Dᴏᴄᴜᴍᴇɴᴛs Are Sᴜᴘᴘᴏʀᴛᴇᴅ")
            return
    ...
    pasted = f"**Sᴜᴄᴄᴇssғᴜʟʟʏ Pᴀsᴛᴇ To Pᴀsᴛʏ**\n\n**Lɪɴᴋ:** • [CʟɪᴄᴋHere]({p_link})\n\n**Rᴀᴡ Lɪɴᴋ:** • [CʟɪᴄᴋHere]({p_raw})"
