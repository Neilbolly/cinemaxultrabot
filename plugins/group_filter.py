...
async def advantage_spell_chok(msg):
    ...
    gs_parsed = []
    if not g_s:
        k = await msg.reply("I was unable to locate a movie by that name.")
    ...
    if not movielist:
        k = await msg.reply("I Count Find Anything Related To That. Check Your Spelling")
        await asyncio.sleep(8)
        return await k.delete()
    ...
    await msg.reply("I Count Find Anything Related To That. DID You Mean Any One Of These?", reply_markup=InlineKeyboardMarkup(btn))
